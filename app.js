...
var Quantity=20;
document.write(VistorName+" orderd "+Quantity+ProductTitle +" from my store");



// chapter  no 4

//1 three variables in one statement
var  names, age , Dept;
//2 Declare 5 legal & 5 illegal variable names


// illegal variables first
// var 1name a- %ra;

//legal variables

var $name , _age , Id , FirstNAme;


// 3. Display this in your browser 
document.write("a) A heading stating “Rules for naming JS variables” <br> b)  Variable names can only contain ______, ______, ______ and ______. For example $my_1stVariable<br> c) Variables must begin with a ______, ______ or _____. For example $name, _name or name d) Variable names are case _________ <br> e) Variable names should not be JS _________"); 
...
var nbr;
document.write("value of variable after declaration is "+ nbr);
document.write("<br>");
var nm=4;
document.write("initial value: "+ nm);
document.write("<br>");
var y= nm++;
document.write("value after increment: "+ y);
document.write("<br>");
y= y+7;
document.write("value after adding: "+ y);
document.write("<br>");
y=--y;
document.write("value after decrement: "+ y);
document.write("<br>");
y=y%3;
document.write("the reminder is : "+ y);
document.write("<br>");
...
document.write("<br><br>");
document.write("Question no 13");
document.write("<br><br>");
var snack= "brownie";
document.write("favourite snack is: "+snack);
var age=21;
document.write("<br>current age is: "+age);
var MaxAge=80;
document.write("<br>Max age is: "+MaxAge);
var amount=2;
document.write("<br>amount is: "+amount);
...
document.write("<br><br>");
var a =10;
document.write("Rresult:\n The vlue of a is: "+a);
b=++a;
document.write("<br><br>");
document.write("the value after ++a is: "+b);
document.write("<br>Now the value of a is: "+b);
document.write("<br><br>");
c=a++;
document.write("the value after a++ is: "+ c);
document.write("<br>Now the value of a is: "+ c);
d=a--;
document.write("<br><br>");
document.write("the value after a-- is: "+d);
...
var result=--a;
document.write("<br><br>");
document.write("the value after --a is: "+result);
result=result- --b;
document.write("<br><br>");
document.write("the value after - --b is: "+result);
result=result+ ++b;
document.write("<br><br>");
document.write("the value after + ++b is: "+result);
result=result+ b--;
...
alert('thanks for giving us your suggession your opinion is worthmore');


// question no 4
var nmbr=prompt('enter your nmbr');
for(var i=1;i<=10;i++){
    document.write(nmbr+"*"+i+"="+nmbr*i);
    document.write("<br>");
}
...
var TotalMarks = 100;
var percentageEng=( english * 100)/TotalMarks;
var percentageUrdu=( urdu*100)/TotalMarks;
var percentageMath=( math *100)/TotalMarks;
document.write("<b>Subject   total marks  obtained marks  percentage</b>  <br>");
document.write("<br><b>English</b>  "+"   "+TotalMarks+"   "+"   "+english+"  " +"   "+percentageEng+"%");
document.write("<br> <b>urdu</b>   "+"   "+TotalMarks+"   "+"   "+urdu+ "  "+"   "+percentageUrdu+"%"  );
document.write("<br> <b>math</b>   "+"   "+TotalMarks+"   "+"   "+math+"  "+"   "+percentageMath+"%" );
